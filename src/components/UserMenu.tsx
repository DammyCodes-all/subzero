...
export function UserMenu() {
  ...
  return (
    ...
    >
      ...
      <PopoverPortal>
        <PopoverPositioner align="end" sideOffset={10} className="z-[100]">
          <PopoverPopup className="z-[100] w-60 origin-top-right rounded-xl bg-popover p-2 shadow-2xl shadow-black/50 ring-1 ring-border/60 outline-none">
            ...
            <div aria-hidden="true" className="my-1 h-px bg-border/50" />
            ...
            <Link
              ...
              className="flex items-center gap-2.5 rounded-lg px-2 py-2 text-[13px] font-medium text-foreground transition-colors hover:bg-secondary"
            >
              <HugeiconsIcon
                icon={
            ...
            <button
              ...
              className="flex w-full cursor-pointer items-center gap-2.5 rounded-lg px-2 py-2 text-left text-[13px] font-medium text-foreground transition-colors hover:bg-secondary"
            >
              <HugeiconsIcon
                icon={
