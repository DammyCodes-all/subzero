...
export function CompactAttentionRow({ sub }: { sub: Sub }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border bg-card/30 px-3 py-2.5 hover:bg-[var(--card-hover)] transition-colors">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <span className="font-mono text-xs font-medium tabular-nums text-muted-foreground hidden sm:inline">
