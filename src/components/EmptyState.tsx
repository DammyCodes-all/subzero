...
function AuthenticatedEmptyState() {
  ...
  const [scanSize, setScanSize] = useState(260);
  useEffect(() => {
    const upd = () => {
      const w = window.innerWidth;
      if (w < 360) setScanSize(220);
      else if (w < 480) setScanSize(240);
      else if (w < 768) setScanSize(260);
      else if (w < 1280) setScanSize(280);
      else setScanSize(300);
    };
    upd();
