...
// Vendored from animate-ui `primitives-effects-highlight` — the spring glow
// that glides behind hovered sidebar items in `components-radix-sidebar`.
// Upstream: https://github.com/imskyleen/animate-ui (MIT)
// Only change: local `@/lib/utils` import.
...
const HIGHLIGHT_SPRING: Transition = {
  type: "spring",
  stiffness: 350,
  damping: 35,
};
